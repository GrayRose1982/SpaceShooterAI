...
public class JoyStick : MonoBehaviour,IDragHandler, IPointerUpHandler, IPointerDownHandler
{
	...
	public Vector2 finalDifference;
...
//	 	Vector2 finalDifference = new Vector2 (finalStickAnchoredPosition.x, finalStickAnchoredPosition.y) - _intermediateStickPosition;
		finalDifference = (new Vector2 (finalStickAnchoredPosition.x, finalStickAnchoredPosition.y) - _intermediateStickPosition) * _oneOverMovementRange;
